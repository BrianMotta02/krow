...
export default function ResetPassword() {
  ...
  function handleDone() {
    if (!password || !confirm) { Alert.alert('Atenção', 'Preencha os campos.'); return; }
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <TextInput style={styles.input} placeholder="Digite sua nova senha" placeholderTextColor="#b0b5c8" secureTextEntry value={password} onChangeText={setPassword} />
