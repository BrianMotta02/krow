...
export default function ForgotPassword() {
  ...
  function handleConfirm() {
    ...
    // Sem e-mail real — vai direto para redefinir senha
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.descBox}>
          <Text style={styles.desc}>Para redefinir sua senha, informe o seu e-mail cadastrado na sua conta e lhe enviaremos um código.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  descBox: { backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 20 },
  desc: { fontSize: 13, color: '#4a5068', lineHeight: 20, textAlign: 'center' },
  input: { backgroundColor: '#fff', borderRadius: 10, borderWidth: 1.5, borderColor: '#dde0ea', paddingHorizontal: 16, paddingVertical: 13, fontSize: 14, color: '#1a2540', marginBottom: 16 },
  btnPrimary: { backgroundColor: '#1e5fc2', borderRadius: 10, paddingVertical: 15, alignItems: 'center', marginBottom: 32 },
